...
// import creditScoreIcon from "../../../assets/credit score icon.svg";
// import repaymentIcon from "../../../assets/repayment icon.svg";
// import takeLoanIcon from "../../../assets/take loan icon.svg";
...
//     <div className="text-[#A0B0AB] text-[16px] px-6 pt-8 bg-white w-[320px] h-[2096px] shrink-0 rounded-tl-none rounded-bl-none rounded-tr-[20px] rounded-br-[20px] border-r border-[#00000014]">
//       <WapfiLogo />
//       <div className="w-[294px] h-[760px] flex flex-col items-start self-stretch gap-2.5 grow shrink-0 basis-0">

//         <NavLink
//           to="/sidebar"
//           className={({ isActive }) =>
//             `w-[278px] flex items-center gap-3 self-stretch h-[40px] py-[8px] px-[16px] rounded-[12px] ${
//               isActive ? "bg-[#439182] text-white" : "text-[#A0B0AB]"
//             }`
//           }
//         >
...
//           }
//         >
//           <img src={takeLoanIcon} alt="take loan icon" />
//           <p>Take a Loan</p>
//         </NavLink>
...
//           }
//         >
//           <img src={repaymentIcon} alt="repayment icon" />
//           <p>Repayments</p>
//         </NavLink>
...
//           }
//         >
//           <img src={creditScoreIcon} alt="credit score icon" />
//           <p>Credit Score</p>
//         </NavLink>
...
//         <NavLink
//           to="/logout"
//           className="w-[278px] text-[#2D6157] flex items-center gap-3 self-stretch h-[40px] py-[8px] px-[16px] mt-38"
//         >
//           <img src={logoutIcon} alt="log out icon" />
//           <p>Log Out</p>
//         </NavLink>
