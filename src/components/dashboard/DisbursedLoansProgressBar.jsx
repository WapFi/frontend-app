...
// export default function DisbursedLoansProgressBar({ totalloanAmount, amountRepaid }) {
...
      {/* Total Loan Amount Positioned Below the Bar */}
      <p
        className="flex justify-self-end gap-1 items-center font-raleway font-medium text-[#444] self-end my-2"
        style={{
          top: 15,
          right: 0,
        }}
