...
//       <p className="text-[#222] font-raleway font-semibold text-[24px] mb-6 pl-2.5 lg:pl-0 lg:text-[32px] lg:block lg:mt-5">
//         Settings
//       </p>
//       <div className="px-6 lg:flex lg:justify-between border lg:px-1">
//         <div className="flex flex-col gap-5 pl-4 lg:w-[20%]">
...
//               />
//             </svg>
//             <span className="text-[#404040] md:text-[16px] font-medium">
...
export default function SettingsWrapper() {
  ...
  const isIdentityVerification = location.pathname.endsWith("/identity-verification");

  return (
    <div className="lg:w-[90%] lg:mx-auto">
      <p className="hidden text-[#222] font-raleway font-semibold text-[24px] mb-6 pl-2.5 lg:pl-0 lg:text-[32px] lg:block lg:mt-5">
        Settings
      </p>

      <div className="px-6 lg:flex lg:justify-between lg:gap-5 lg:px-1">
        <div
          className={`flex flex-col gap-5 pl-4 lg:w-[22%] ${
            isIdentityVerification ? "hidden lg:flex" : "flex"
          }`}
        >
          <button
            onClick={() => navigate("/settings/identity-verification")}
            className={`flex items-center gap-2.5 px-2 py-1 rounded-lg cursor-pointer ${
              isIdentityVerification ? "bg-white text-[#439182]" : "text-[#404040]"
            }`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div
          className={`w-full ${
            isIdentityVerification ? "flex" : "hidden"
          } lg:flex lg:w-[78%] lg:px-7 lg:pb-20`}
        >
          <Outlet />
        </div>
      </div>
