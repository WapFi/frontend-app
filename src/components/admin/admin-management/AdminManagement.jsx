        ...
        <div className="space-y-6">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {admins.map((admin) => (
                            <tr key={admin._id}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">{admin.identifier}</td>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <button
                                        onClick={() => handleDeactivateAdmin(admin._id, admin.status)}
                                        className={`px-3 py-1 rounded-full text-xs font-medium cursor-pointer ${admin.status === "ACTIVE" ? "bg-red-100 text-red-700 hover:bg-red-200" : "bg-green-100 text-green-700 hover:bg-green-200"}`}
                                    >
            ...
            {showAddModal && (
                <AddAdminModal
                    ...
                    onAdminAdded={() => { setShowAddModal(false); setRefresh(r => !r); }}
                />
            )}
        </div>
    );
