  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow">
        <div className="px-4 sm:px-6 py-4 border-b border-gray-200 flex flex-col gap-4 md:flex-row md:justify-between md:items-center">
          <div>
          ...
          <div className="w-full md:w-auto">
            <input
              ...
              className="w-full md:w-auto text-sm text-gray-500 border border-gray-300 rounded-md px-2 py-2 focus:outline-none focus:ring-1 focus:ring-yellow-500 focus:border-yellow-500"
            />
          </div>
