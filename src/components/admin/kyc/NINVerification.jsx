...
function NINVerification() {
    ...
    const handleVerify = async (userId) => {
        ...
        try {
            ...
            setNinData((prev) => prev.map(u => u._id === userId ? { ...u, status: "verified" } : u));
        } catch (err) {
    ...
    const handleReject = async (userId) => {
        ...
        try {
            ...
            setNinData((prev) => prev.map(u => u._id === userId ? { ...u, status: "rejected" } : u));
        } catch (err) {
    ...
    if (loading) return <div className="p-6 text-center">Loading NIN verifications...</div>;
