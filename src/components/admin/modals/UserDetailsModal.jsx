...
import { getUserDetails, updateUserStatus } from "../../../api/adminApi";
  ...
  return (
    <div className="fixed inset-0 bg-white sm:bg-black/40 z-50 overflow-y-auto">
      <div className="min-h-screen sm:flex sm:items-center sm:justify-center sm:p-4">
        <div className="w-full min-h-screen bg-white sm:min-h-0 sm:max-w-4xl sm:max-h-[90vh] sm:rounded-lg sm:shadow-xl sm:overflow-y-auto">
          {/* Header */}
          <div className="flex items-center justify-between px-4 sm:px-6 pb-2 pt-5 sm:pt-6">
          ...
          <div className="px-4 py-5 sm:p-6 space-y-5 sm:space-y-6">
            ...
            <div className="flex flex-col items-center text-center sm:flex-row sm:items-center sm:text-left gap-4 border border-gray-200 p-4 rounded-t-lg mb-0">
              ...
              <div className="min-w-0 w-full">
                ...
                <div className="mt-3 space-y-3 sm:flex sm:flex-wrap sm:items-center sm:gap-4 sm:space-y-0">
                  {/* Phone with icon */}
      ...
      {showBlockModal && (
        <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-5 sm:p-8 text-center">
