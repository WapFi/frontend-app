					...
					<div className="flex items-center space-x-6">
						...
						<div className="flex items-center space-x-2">
							...
							<svg width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M4 4.06L10.87 9.95C10.94 10.01 11.06 10.01 11.13 9.95L18 4.06M2.2 1H19.8C20.46 1 21 1.54 21 2.2V14.6C21 15.92 19.92 17 18.6 17H3.4C2.08 17 1 15.92 1 14.6V2.2C1 1.54 1.54 1 2.2 1Z" stroke="#444444" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
							</svg>
          ...
          <div className="space-y-4  border border-gray-200 p-4 rounded-b-lg border-t-0">
				...
				<div className="grid grid-cols-3 gap-4">
					...
					<div className="p-3 rounded-lg">
						...
						<p className="text-lg font-semibold text-gray-900">{user.totalLoanTaken}</p>
					</div>
					...
					<div className="p-3 rounded-lg">
						...
						<p className="text-lg font-semibold text-gray-900">{user.outstandingLoan}</p>
					</div>
				</div>
				...
				<div className="grid grid-cols-3 gap-4">
					...
					<div className="p-3 rounded-lg">
						<p className="text-xs text-gray-500 uppercase tracking-wide">Loan Due Date</p>
						<p className="text-lg font-semibold text-gray-900">{user.totalLoanTaken}</p>
					</div>

					<div className="p-3 rounded-lg">
						<p className="text-xs text-gray-500 uppercase tracking-wide">Outstanding Loan</p>
						<p className="text-lg font-semibold text-gray-900">{user.totalLoanTaken}</p>
					</div>
      ...
      {showBlockModal && (
        <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-xl w-full p-8 text-center">
            <h3 className="text-lg font-semibold text-gray-900 py-8">Block User</h3>
      ...
      {showDeactivateModal && (
        <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-8 text-center">
            <h3 className="text-lg font-semibold text-gray-900 py-8">Deactivate User</h3>
