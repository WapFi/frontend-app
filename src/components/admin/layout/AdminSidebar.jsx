    ...
    switch (type) {
      case "dashboard":
        return (
          ...
          >
            ...
            />
            <path
              d="M6.84381 20.563V14.7192C6.84381 14.1557 7.06769 13.6152 7.46621 13.2166C7.86472 12.8181 8.40523 12.5942 8.96881 12.5942H10.0313C10.5949 12.5942 11.1354 12.8181 11.5339 13.2166C11.9324 13.6152 12.1563 14.1557 12.1563 14.7192V20.563"
              stroke="#A0B0AB"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
      ...
      case "user":
        return (
          ...
          >
            <path
              d="M9 8.99998C11.2091 8.99998 13 7.20912 13 4.99999C13 2.79086 11.2091 1 9 1C6.79086 1 5 2.79086 5 4.99999C5 7.20912 6.79086 8.99998 9 8.99998Z"
              stroke="#A0B0AB"
              strokeWidth="1.8"
            />
            <path
      ...
      case "admin":
        return (
          ...
          >
            <path
              d="M10 1C6.685 1 4 3.685 4 7C4 10.315 6.685 13 10 13C13.315 13 16 10.315 16 7C16 3.685 13.315 1 10 1ZM10 11C7.791 11 6 9.209 6 7C6 4.791 7.791 3 10 3C12.209 3 14 4.791 14 7C14 9.209 12.209 11 10 11Z"
              fill="#A0B0AB"
            />
            <path
              d="M10 14C5.589 14 2 17.589 2 22H4C4 18.691 6.691 16 10 16C13.309 16 16 18.691 16 22H18C18 17.589 14.411 14 10 14Z"
              fill="#A0B0AB"
            />
            <path
              d="M15 6L17 8L20 5"
