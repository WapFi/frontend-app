...
function VerifyPhoneEmail() {
  ...
  return (
    ...
    >
      <div>
        <WapfiLogo />
        <div className="mx-auto flex flex-col items-center gap-[40px] w-[389px] h-[621px] md:w-[75%] md:text-[18px] lg:w-[511px] lg:h-[621px] lg:gap-[40px] lg:self-center lg:mx-12 xl:mx-14 2xl:ml-32">
          <form
            onSubmit={handleSubmit(onSubmit)}
