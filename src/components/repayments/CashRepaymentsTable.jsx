  ...
  return (
    <div className="px-3.5 mb-12 md:px-10">
      ...
      <div className="hidden lg:block bg-white rounded-2xl py-4">
        ...
        <div className="grid grid-cols-3 py-3 px-4 border-y border-y-[rgba(0,0,0,0.04)] text-[#333] font-medium bg-[#fafafa]">
          <p>{t("cashRepaymentsTable.date")}</p>
          <p>{t("cashRepaymentsTable.amount")}</p>
          <p>{t("cashRepaymentsTable.status")}</p>
        </div>
        ...
        <div className="flex items-center justify-between mt-4 px-4">
          ...
          >
            {t("cashRepaymentsTable.previous")}
          </button>
